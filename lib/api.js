...
export const getOpenAIResponse = async (question, model, extractedText) => {
  ...
  } else if (model.startsWith("llama-") || model.startsWith("deepseek-") || model.startsWith("meta-llama")) {
  ...
  let apiUrl =
    model.startsWith("gpt") || model === "o3-mini"
      ...
      : model.startsWith("llama") || model.startsWith("deepseek") || model.startsWith("meta-llama")
...
// Gemini API Request
export const getGeminiResponse = async (question, model, apiLLMKey, extractedText) => {
